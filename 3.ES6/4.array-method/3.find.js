...
/*
In the case of find, if the condition is fulfilled, it will directly 
provide the first data, not in array. If the condition is not fulfilled,
it will give undefined. On the other hand, in the case of filter, 
if the condition is fulfilled, it will give the output in an array. 
And, if the condition is not fulfilled, it will give an empty array([]).
*/